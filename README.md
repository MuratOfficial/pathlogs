...
- **Обсуждение**: комментарии к задачам с Markdown; удалять можно только свои (или админу)
...
- **Аналитика проекта** (вкладка): распределение по статусам/типам/приоритетам, «оценка vs факт» по задачам, часы по сотрудникам
...
prisma/schema.prisma        — модели: User, Project, Task (self-relation = ветки),
                              ...
                              ChecklistItem, Comment, Notification
