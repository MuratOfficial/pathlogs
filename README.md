...
- **Прокрутка протяжкой**: доску, Гант, ряды вкладок и широкие таблицы можно листать, зажав их мышью, — как панорамирование в графе веток; после броска лента доезжает по инерции.
