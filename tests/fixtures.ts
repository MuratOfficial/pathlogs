...
export async function resetDb() {
  await prisma.$executeRawUnsafe(
    'TRUNCATE "User","Project","ProjectMember","BoardColumn","Task","TaskLink","PatchLog","TimeEntry","Attachment","ChecklistItem","Comment","Notification","TaskTemplate","SavedFilter","ApiToken","WebhookEndpoint","GitCommitRef","Company","TaskProjectLink" RESTART IDENTITY CASCADE'
  );
}
