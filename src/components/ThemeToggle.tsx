...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-foreground/90 transition hover:bg-surface-2"
    >
      <span className="relative flex h-4 w-4 items-center justify-center text-muted">
        <svg
