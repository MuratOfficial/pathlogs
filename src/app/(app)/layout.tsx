  ...
  const sidebar = (
    <>
      ...
      <nav className="flex-1 space-y-1 px-3">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 rounded-lg px-3 py-[var(--app-nav-py)] text-sm text-foreground/90 transition hover:bg-surface-2"
          >
            ...
            <div className="space-y-1 pt-4">
              ...
              {pinned.map(({ project: p }) => (
                <Link
                  ...
                  href={`/projects/${p.id}`}
                  data-tip={p.name}
                  className="flex items-center gap-2.5 rounded-lg px-3 py-[var(--app-nav-py)] text-sm text-foreground/90 transition hover:bg-surface-2"
                >
                  <span
                    aria-hidden
          ...
          <div className="flex items-center gap-3 rounded-lg px-2 py-2">
            ...
            <form action={logoutAction}>
              <button
                type="submit"
                data-tip="Выйти"
                className="flex h-9 w-9 items-center justify-center rounded-lg text-muted transition hover:bg-surface-2 hover:text-red-400"
              >
